...
test.describe('Accordion Visual Tests', () => {
  ...
  test('accordion visual test at Mobile viewport', async ({ page }) => {
    // Set viewport size
  ...
  test('accordion visual test at Tablet viewport', async ({ page }) => {
    // Set viewport size
  ...
  test('accordion visual test at Desktop viewport', async ({ page }) => {
    // Set viewport size
  ...
  test('accordion visual test at Large viewport', async ({ page }) => {
    // Set viewport size
